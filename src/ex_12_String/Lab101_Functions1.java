...
public class Lab101_Functions1 {
    public static void main(String[] args) {
        ...
        System.out.println(name.substring(1,4)); //d->0 i->1 start from 1 leave/ignore from 4
        System.out.println(name.substring(0,3)); //d->0 i->1 start from 0 leave/ignore from 3
